...
//    // inject employee dao, dirty practice (using constructor injection)
//    public EmployeeRestController(EmployeeDAO theEmployeeDAO){
//        employeeDAO = theEmployeeDAO;
//    }
// instead of using DAO we use service class and use all methods for crud
    private EmployeeService employeeService;
    public EmployeeRestController(EmployeeService theEmployeeService){
        employeeService = theEmployeeService;
    }

    // expose "/employees" endpoint & return list of employees
    ...
    // adding -> id is passed in json, saving/inserting a new item instead of updating
